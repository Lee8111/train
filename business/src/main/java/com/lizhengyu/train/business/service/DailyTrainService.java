...
import com.lizhengyu.train.business.domain.DailyTrainExample;
import com.lizhengyu.train.business.domain.Train;
import com.lizhengyu.train.business.mapper.DailyTrainMapper;
...
public class DailyTrainService {
    ...
    public void genDailyTrain(Date date,Train train){
        ...
        LOG.info("生成日期[{}]车次【{}】的信息结束", DateUtil.formatDate(date));
    }
}
